...
###### Here is the teacher's dashboard, which is filled with his statistical cards, as shown
![image](https://user-images.githubusercontent.com/108693961/211425682-ac49e7a4-f631-4b7d-941f-9e5337e30b82.png)

###### Here the list of courses for the teacher appears and all the data related to it, such as the number of students in each course, the possibility of modifying the course data, adding a chapter to the course, adding a quiz, adding the materal to the course, and finally the possibility of deleting it
...
###### Here is the teacher's data modification page with the same

![image](https://user-images.githubusercontent.com/108693961/211426144-f976d1d1-9b8f-4a7d-b855-f5a1212f190e.png)


###### Here the main page of the site appears, where all the courses uploaded to the system or the most popular one can be shown, and this is according to the evaluation and the number of participants for the course, and also the list of teachers appears on the site
...
###### Course data page. If the student is logged into an account, he can subscribe to the course as shown in the picture
...
###### The teacher's data, all his courses, the total number of students enrolled in the courses, and the teacher's average evaluation
...
###### List of courses in which the student is registered, the name of the instructor for each course appears, the short exam list and the standard exam related to the courses, and communication with the course instructor
...
###### List of short exams related to a specific course and whether they are solved or not
